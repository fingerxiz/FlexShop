<template>
  <div v-if="visible" class="guest-menu-overlay" :style="overlayStyle" @click.self="close">
    <div class="guest-menu" :style="menuStyle" role="dialog" aria-label="Меню пользователя">
      <router-link to="/" class="menu-button" @click="close">
        <img src="/src/assets/icons/buy.svg" alt="home" class="menu-icon" />
        <span>Главная</span>
      </router-link>
      <router-link to="/orders" class="menu-button" @click="close">
